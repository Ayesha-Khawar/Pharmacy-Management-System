...
namespace Pharmacy.pharmacyDataSetTableAdapters {
    ...
    public partial class loginTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[login] SET [LoginID] = @LoginID, [Password] = @Password WHERE (([Lo" +
                "ginID] = @Original_LoginID) AND ([Password] = @Original_Password));\r\nSELECT Logi" +
                "nID, Password FROM login WHERE (LoginID = @LoginID)";
        ...
        public virtual int Delete(string Original_LoginID, string Original_Password) {
        ...
        public virtual int Update(string LoginID, string Password, string Original_LoginID, string Original_Password) {
            if ((LoginID == null)) {
                throw new global::System.ArgumentNullException("LoginID");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Password, string Original_LoginID, string Original_Password) {
            return this.Update(Original_LoginID, Password, Original_LoginID, Original_Password);
        }
    }
